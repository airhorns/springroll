...
Item.create([{
    :name => "Spring Roll", :description => "A tasty treat", :menu => menus.first, 
    ...
    :name => "Caesar Salad", :description => "How are your croutons, Brutus?", :menu => menus.second,
    ...
    :sizes => Size.create([{:name => "", :price => "10.99"}])
  }, {
    ...
    :sizes => Size.create([{:name => "", :price => "5.99"}])
  }])